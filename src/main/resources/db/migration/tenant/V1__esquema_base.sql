...
create table ingresos_material (
    ...
    metodo_pago     varchar(20) check (metodo_pago in ('EFECTIVO','TRANSFERENCIA')),
...
create table detalles_ingreso (
    ...
    -- Material del catalogo; nullable por los ingresos historicos sin FK
...
create index idx_detalles_material on detalles_ingreso (material_id);
create index idx_ingresos_fecha    on ingresos_material (fecha desc);
