...
public class ProveedorServiceImpl implements ProveedorService {
    ...
    public RespuestaPagina<RespuestaProveedor> listar(EstadoProveedor estado, String nombre, int page, int size) {
        var pagina = proveedorRepository.buscar(estado, nombre, PageRequest.of(page, size));
    ...
    public List<RespuestaEntregaProveedor> entregas(UUID id) {
        buscarEntidad(id);
        return entregaRepository.findByConvenioProveedorIdOrderByFechaRecepcionDesc(id).stream()
